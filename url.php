    ...
    <div class="nav-bg light"></div>
			...
			<section id="spec-inner-page" class="pb-125 pt-100 light">
    			<div class="container">
        			<div class="row">
            			<div class="col-md-9">
                            <h2>Publish images with a url link</h2>    
                            ...
                            <?php 
                            if(isset($_POST['image']) and !(isset($_SESSION['id_user']))){
                            ...
                            if(isset($_POST['image']) and (isset($_SESSION['id_user']))){
                                if($_POST['image'] != NULL){
                                    $req = $dbh->prepare('INSERT INTO urlpic VALUES(?,?,?)');
                                    $req->execute(array("",$_POST['image'],$_SESSION['id_user']));

                                    echo '<img src="'.$_POST['image'].'" style="width:25%; height:25%">';
                                    header('Location: user.php?pseudo='.$_SESSION['user-connecte']);
                                }
                                else{
                                    echo "<p style='color:red'>No link selected! Try again</p>";
                                }
                            }
                            ?> 
