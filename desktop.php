    ...
    <div class="nav-bg light"></div>
			...
			<section id="spec-inner-page" class="pb-125 pt-100 light">
    			<div class="container">
        			<div class="row">
            			<div class="col-md-9">
                            <h2>Publish images from your Desktop</h2>    
                            ...
                            <?php
                                ...
                                if(isset($_FILES['image']) and !(isset($_SESSION['id_user']))){
                                ...
                                if(isset($_FILES['image']) and isset($_SESSION['id_user'])){
                                    ...
                                    echo "</pre>";
                                    */
                                    $req = $dbh->prepare('INSERT INTO desktoppic VALUES(?,?,?)');
                                    $req->execute(array("",$_FILES['image']['name'],$_SESSION['id_user']));    
